/* ──────────────────────────────────────────────────────────
   ...
   Phase 6a: read-only consumer of `view:roadmap`. The only
   store touch-point is ephemeral navigation (`setView`).
   ────────────────────────────────────────────────────────── */
...
import type { Milestone, Roadmap } from "@northstar/core";
import { formatDate } from "../../utils/dateFormat";
import "./RoadmapPage.css";

// MUST match packages/server/src/views/roadmapView.ts
