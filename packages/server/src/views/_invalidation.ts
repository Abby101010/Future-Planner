...
export const commandToInvalidations: Record<CommandKind, QueryKind[]> = {
  ...
  "command:toggle-task": ["view:dashboard", "view:tasks", "view:planning", "view:goal-plan"],
  "command:skip-task": ["view:dashboard", "view:tasks"],
  "command:delete-task": ["view:dashboard", "view:tasks", "view:goal-plan"],
  "command:delete-tasks-for-date": ["view:dashboard", "view:tasks", "view:goal-plan"],
  "command:update-task": ["view:dashboard", "view:tasks", "view:goal-plan"],
  ...
  "command:defer-overflow": ["view:dashboard", "view:tasks"],
  "command:undo-defer": ["view:dashboard", "view:tasks"],
